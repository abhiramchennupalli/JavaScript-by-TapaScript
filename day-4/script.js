...
const week = "wednesday";
switch (week) {
    case 'monday':
        console.log("Welcome Monday");
        break;
    case 'tuesday': console.log('welcome tuesday');
        break;
    case 'wednesday': console.log('welcome wednesday');
        break;
    case 'thursday': console.log('welcome thursday');

        break;
    case 'friday': console.log('welcome friday');
        break;
    case 'saturday': console.log('welcome saturday');
        break;
    case 'sunday': console.log('welcome sunday');
        break;
    default: console.log('Select correct day');

}

let comingSchool = true ? console.log('you are present') : console.log('you are absent');
