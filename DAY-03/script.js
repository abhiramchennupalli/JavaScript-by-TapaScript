// DAY-03 script placeholder
console.log('DAY-03 script running');
//1. Odd or Even?
...
let age = 12;
age >= 18 ? console.log('You are Elegible for Voting') : console.log('Your are under age for voting');
...
let ctc_salary = (12300 * 12) + (12300 * 12 * 0.2);
console.log(ctc_salary);
